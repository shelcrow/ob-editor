<!-- 
Child of EditDefinition, edit definition form disabled
-->
...
<template>
    <div>
        <b-form>
            ...
            >
                <b-form-input id="edit-node-description-input" v-model="$store.state.nodeDescription" disabled></b-form-input>
            </b-form-group>
        </b-form>
    </div>
</template>
