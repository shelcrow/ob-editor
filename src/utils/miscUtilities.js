...
export function getArrayItemAsChildren(workingFile, arrayItemRef, key, loadedFiles) {
    ...
    if (file[arrayItemDefName]["allOf"]) {
        ...
        deepArrayItemProperties = JSON.parse(JSON.stringify(file[arrayItemDefName]["properties"]))
...
export function getArrayItemType(arrItemRef, loadedFiles, currentFile) {
    ...
    if (fileContext == 'LOCAL') {
        file = currentFile
        // console.log('in misc utilities, get arrayitemType, local file: ')
        // console.log(file)
    } else {
        file = loadedFiles[fileContext]
        // console.log('in misc utilities, getarrayitemtype, non-local file: ') 
        // console.log(file)
    }
    ...
    // console.log('in getarrayitemtype miscutil, for ' + arrItemRef + ' type is: ' + arrItemType)
